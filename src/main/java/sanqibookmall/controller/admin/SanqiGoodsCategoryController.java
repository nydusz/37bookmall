...
public class SanqiGoodsCategoryController {
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(sanqiCategoryService.getCategorisPage(pageUtil));
    }
    ...
    public Result listForSelect(@RequestParam("categoryId") Long categoryId) {
        ...
        GoodsCategory category = sanqiCategoryService.getGoodsCategoryById(categoryId);
        ...
        if (category.getCategoryLevel() == CategoryLevelEnum.LEVEL_ONE.getLevel()) {
            ...
            List<GoodsCategory> secondLevelCategories = sanqiCategoryService.selectByLevelAndParentIdsAndNumber(Collections.singletonList(categoryId), CategoryLevelEnum.LEVEL_TWO.getLevel());
        ...
        if (category.getCategoryLevel() == CategoryLevelEnum.LEVEL_TWO.getLevel()) {
            ...
            List<GoodsCategory> thirdLevelCategories = sanqiCategoryService.selectByLevelAndParentIdsAndNumber(Collections.singletonList(categoryId), CategoryLevelEnum.LEVEL_THREE.getLevel());
            categoryResult.put("thirdLevelCategories", thirdLevelCategories);
        }
    ...
    public Result save(@RequestBody GoodsCategory goodsCategory) {
        ...
        String result = sanqiCategoryService.saveCategory(goodsCategory);
    ...
    public Result update(@RequestBody GoodsCategory goodsCategory) {
        ...
        String result = sanqiCategoryService.updateGoodsCategory(goodsCategory);
        if (ServiceResultEnum.SUCCESS.getResult().equals(result)) {
            return ResultGenerator.genSuccessResult();
        } else {
            return ResultGenerator.genFailResult(result);
    ...
    public Result info(@PathVariable("id") Long id) {
        GoodsCategory goodsCategory = sanqiCategoryService.getGoodsCategoryById(id);
    ...
    public Result delete(@RequestBody Integer[] ids) {
        ...
        if (sanqiCategoryService.deleteBatch(ids)) {
            return ResultGenerator.genSuccessResult();
        } else {
